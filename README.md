...
- [revision]([https://github.com/bapatchirag/revision](https://github.com/bapatchirag/revision)) A lazygit-style TUI for Subversion (SVN) — review diffs, stage with changelists, commit, update and browse history
